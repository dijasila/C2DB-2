...
structures = ['initial_C2', 'initial_Ge2Se2', 'final_C2', 'final_Ge2Se2']
for name in structures:
    ...
    # top view
    filename = run_povray(atoms, rotation='0x,0y', bondatoms=bondatoms)
    # rename file
    os.system(f'mv {filename} {name}_top.png')
    # cut view
